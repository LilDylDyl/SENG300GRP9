...
public class CancelAppointmentStaff1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CancelAppointmentStaff1 frame = new CancelAppointmentStaff1();
	 ...
	 * Create the frame.
	 */
	public CancelAppointmentStaff1() {
		setTitle("Cancel Appointments");
		setResizable(false);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				CancelAppointmentStaff2 cancelAppointmentStaff2 = new CancelAppointmentStaff2();
				cancelAppointmentStaff2.setVisible(true);
			}
		});
