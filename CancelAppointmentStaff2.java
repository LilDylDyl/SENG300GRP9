...
public class CancelAppointmentStaff2 extends CancelAppointmentStaff1 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CancelAppointmentStaff2 frame = new CancelAppointmentStaff2();
	 ...
	 * Create the frame.
	 */
	public CancelAppointmentStaff2() {
