...
public class ViewAppointmentStaff2 extends ViewAppointmentStaff1 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewAppointmentStaff2 frame = new ViewAppointmentStaff2();
	...
	public ViewAppointmentStaff2() {
		...
		String docName = "", patientUsername = "", patientUsername2 = "", patientUsername3 = "", patientUsername4 = "", patientUsername5 = "", patientUsername6 = "", patientUsername7 = "", patientUsername8 = "", patientUsername9 = "", patientUsername10 = "", date = "", month = "", time = "", date2 = "", month2 = "", time2 = "", date3 = "", month3 = "", time3 = "", date4 = "", month4 = "", time4 = "", date5 = "", month5 = "", time5 = "", date6 = "", month6 = "", time6 = "", date7 = "", month7 = "", time7 = "", date8 = "", month8 = "", time8 = "", date9 = "", month9 = "", time9 = "", date10 = "", month10 = "", time10 = "";
		int numberOfAppointments = ViewAppointmentDoctor.numberOfAppointmentsDoctor(doctorChosen);
		...
		if (numberOfAppointments == 1) {
			...
			patientUsername = Appointment.getAppointmentsDoctor(doctorChosen).get(0);
			docName = Appointment.getAppointmentsDoctor(doctorChosen).get(1);
			date = Appointment.getAppointmentsDoctor(doctorChosen).get(2);
			month = Appointment.getAppointmentsDoctor(doctorChosen).get(3);
			time = Appointment.getAppointmentsDoctor(doctorChosen).get(4);
			...
			patientUsername2 = Appointment.getAppointmentsDoctor(doctorChosen).get(5);
			date2 = Appointment.getAppointmentsDoctor(doctorChosen).get(7);
			month2 = Appointment.getAppointmentsDoctor(doctorChosen).get(8);
			time2 = Appointment.getAppointmentsDoctor(doctorChosen).get(9);
			...
			patientUsername3 = Appointment.getAppointmentsDoctor(doctorChosen).get(10);
			date3 = Appointment.getAppointmentsDoctor(doctorChosen).get(12);
			month3 = Appointment.getAppointmentsDoctor(doctorChosen).get(13);
			time3 = Appointment.getAppointmentsDoctor(doctorChosen).get(14);
			...
			patientUsername4 = Appointment.getAppointmentsDoctor(doctorChosen).get(15);
			date4 = Appointment.getAppointmentsDoctor(doctorChosen).get(17);
			month4 = Appointment.getAppointmentsDoctor(doctorChosen).get(18);
			time4 = Appointment.getAppointmentsDoctor(doctorChosen).get(19);
			...
			patientUsername5 = Appointment.getAppointmentsDoctor(doctorChosen).get(20);
			date5 = Appointment.getAppointmentsDoctor(doctorChosen).get(22);
			month5 = Appointment.getAppointmentsDoctor(doctorChosen).get(23);
			time5 = Appointment.getAppointmentsDoctor(doctorChosen).get(24);
			...
			patientUsername6 = Appointment.getAppointmentsDoctor(doctorChosen).get(25);
			date6 = Appointment.getAppointmentsDoctor(doctorChosen).get(27);
			month6 = Appointment.getAppointmentsDoctor(doctorChosen).get(28);
			time6 = Appointment.getAppointmentsDoctor(doctorChosen).get(29);
			...
			patientUsername7 = Appointment.getAppointmentsDoctor(doctorChosen).get(30);
			date7 = Appointment.getAppointmentsDoctor(doctorChosen).get(32);
			month7 = Appointment.getAppointmentsDoctor(doctorChosen).get(33);
			time7 = Appointment.getAppointmentsDoctor(doctorChosen).get(34);
			...
			patientUsername8 = Appointment.getAppointmentsDoctor(doctorChosen).get(35);
			date8 = Appointment.getAppointmentsDoctor(doctorChosen).get(37);
			month8 = Appointment.getAppointmentsDoctor(doctorChosen).get(38);
			time8 = Appointment.getAppointmentsDoctor(doctorChosen).get(39);
			...
			patientUsername9 = Appointment.getAppointmentsDoctor(doctorChosen).get(40);
			date9 = Appointment.getAppointmentsDoctor(doctorChosen).get(42);
			month9 = Appointment.getAppointmentsDoctor(doctorChosen).get(43);
			time9 = Appointment.getAppointmentsDoctor(doctorChosen).get(44);
			...
			patientUsername10 = Appointment.getAppointmentsDoctor(doctorChosen).get(45);
			date10 = Appointment.getAppointmentsDoctor(doctorChosen).get(47);
			month10 = Appointment.getAppointmentsDoctor(doctorChosen).get(48);
			time10 = Appointment.getAppointmentsDoctor(doctorChosen).get(49);
